...
int main()
{
    ...
    while(1)
    {
        ...
        case 3:
            ...
            scanf("%d",&value);
            first = InsertBefore(first,n,value);
            printLinkedList(first);
            break;
        case 4:
            printf("\nEnter data:");
...
struct Node * InsertAtFirst(struct Node *first,int n)
{
    int i;
    struct Node *temp = NULL;
    struct Node *head = NULL;
...
struct Node * InsertBefore(struct Node *first,int data,int value)
{
